...
variable "role_map" {
  ...
  default = {
    "RLSGRP_IdentityAdmins" = ["fe930be7-5e62-47db-91af-98c3a49a38b1", 
    ...
    "RLSGRP_InfraAdmins" = ["fe930be7-5e62-47db-91af-98c3a49a38b1",
    ...
    "RLSGRP_SecurityAdmins" = ["194ae4cb-b126-40b2-bd5b-6091b380977d",
                                  "892c5842-a9a6-463a-8041-72aa08ca3cf6",
                                  "b1be1c3e-b65d-4f19-8427-f6fa0d97feb9",
                                  "45d8d3c5-c802-45c6-b32a-1d70b5e1e86e",
